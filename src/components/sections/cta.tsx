...
import { ArrowUpRight, MapPin, Check, Star } from "lucide-react";
                  ...
                  return (
                    <li
                      ...
                      className={`lift rounded-2xl border p-4 backdrop-blur transition-colors ${
                        isCurrent
                          ? "border-mint-500/55 bg-mint-500/[0.12] shadow-[0_0_40px_-12px_rgba(16,185,129,0.45)]"
                          : isDelivered
                    ...
                    >
                      ...
                      <span className="mt-1.5 flex items-center gap-2 text-xl font-semibold text-fg">
                        {stop.city}
                        {isCurrent && (
                          <span className="inline-flex size-5 items-center justify-center rounded-full bg-mint-500/25 text-mint-200 ring-1 ring-inset ring-mint-500/60">
